Mcblooms::Application.configure do
  ...
  ActionMailer::Base.smtp_settings = {
    :address        => "mail.basketcompany.com",
    :port           => 587,
    :authentication => :login,
    :user_name      => "website@basketcompany.com",
    :password       => "ge6a#atre8us"
  }
  config.action_mailer.default_url_options = { :host => "mcblooms.anlek.com" }
end
